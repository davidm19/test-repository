...
def insert(root, value):
    ...
    # If the given value is less than the root's value, place it on the left branch of the tree by calling this method again recursively
    elif value < root.value:
        root.left = insert(root.left, value)

    # If the given value is greater than the root's value, place it on the right branch of the tree by calling this method again recursively
    else:
